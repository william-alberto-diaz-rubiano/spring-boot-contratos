...
public class PageWrapper<T> implements Serializable
{
    ...
    {
//        return new PageWrapper(entityPage.getContent(), entityPage.getPageable(), entityPage.getTotalPages(),
//                               entityPage.isLast(), entityPage.getTotalElements(), entityPage.getSize(),
//                               entityPage.getNumber(), entityPage.getSort(), entityPage.getNumberOfElements(),
//                               entityPage.isFirst(), entityPage.isEmpty());
