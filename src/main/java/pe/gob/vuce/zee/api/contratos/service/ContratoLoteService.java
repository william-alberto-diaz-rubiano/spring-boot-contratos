...
public interface ContratoLoteService {
    ...
    Page<ContratoLoteBandejaDTO> busquedaAvanzada(String numeroContrato, UUID loteId, UUID contratoId, UUID usuarioId, Integer numeroAdenda, String numeroLote, UUID tipoActividad, UUID actividadEconomica, Pageable pageable);
