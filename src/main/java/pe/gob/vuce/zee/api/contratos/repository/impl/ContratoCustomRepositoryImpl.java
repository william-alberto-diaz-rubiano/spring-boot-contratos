...
public class ContratoCustomRepositoryImpl implements ContratoCustomRepository
{
    ...
    @Override
    public List<ContratoEntity> busqueda(UUID id, String numeroContrato, UUID tipoContrato, Integer estado, UUID lote,
                                         String documento, UUID tipoDocumento, String nombreUsuario, UUID usuario,
                                         UUID tipoActividad,LocalDateTime fechaInicial, LocalDateTime fechaFinal)
    {
    ...
    @Override
    public Page<ContratoEntity> busquedaPageable(UUID id,String numeroContrato, UUID tipoContrato, Integer estado, UUID lote,
                                                 String documento, UUID tipoDocumento,String nombreUsuario, UUID usuario,
                                                 UUID tipoActividad, LocalDateTime fechaInicial, LocalDateTime fechaFinal,
                                                 Pageable pageable)
    {
